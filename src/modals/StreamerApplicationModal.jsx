  ...
  const submitApplication = async () => {
    ...
    try {
      const payload = {
        ...
        avatar: userAvatar,
        streamCategory: streamCategory || 'Chatting',
        category: streamCategory || 'Chatting',
        streamTopic: streamTopic || 'General Stream',
        ...
        docUrl: userAvatar || '',
        requestedPose: selectedPose?.title || '✌️ ژست پیروزی',
        camTested: Boolean(camTested),
        micTested: Boolean(micTested),
        status: 'Pending',
