...
const DEFAULT_FAQS = [
  ...
  // 12. DIAMOND
  {
    ...
    answerFa: 'الماس درآمد واقعی استریمرهاست. با دریافت هر هدیه، ۷۰٪ ارزش سکه‌ای آن به‌صورت الماس در کیف پول استریمر ذخیره می‌شود. هر ۱۰۰ الماس برابر با $۰.۵۰ دلار نقد تتر (USDT) است.',
    answerEn: 'Diamonds are streamer earnings. Streamers earn 70% of gift coin value in Diamonds. 100 Diamonds = $0.50 USDT.',
    popular: true,
    active: true
  },
  ...
  // 13. DEPOSIT
  {
    ...
    answerFa: 'واریز و شارژ حساب منحصراً از طریق ارز دیجیتال تتر (USDT TRC20) انجام می‌شود و پس از تأیید تراکنش در شبکه، سکه‌ها بلافاصله به کیف پول اضافه می‌شوند.',
    answerEn: 'Deposit and account recharge is exclusively done via Tether USDT (TRC20). Coins credit immediately after network verification.',
    popular: true,
    active: true
  },
  {
    id: 'faq_15',
    categoryId: 'deposit',
    questionFa: 'در صورت ناموفق بودن پرداخت تتر چه کنم؟',
    questionEn: 'What if USDT deposit fails or is delayed?',
    answerFa: 'در صورت انتقال موفق تتر در بلاک‌چین و عدم شارژ سکه، کد پیگیری تراکنش (TXID / Hash) خود را در تیکت پشتیبانی ارسال کنید تا کمتر از ۱۵ دقیقه بررسی و شارژ گردد.',
    answerEn: 'If USDT was sent on blockchain but coins were not credited, submit your TXID / Hash in a support ticket for quick review within 15 minutes.',
    popular: true,
    active: true
  },
  ...
  // 14. WITHDRAWAL
  {
    ...
    questionFa: 'حداقل مبلغ برداشت درآمد استریمر چقدر است و تسویه به چه روشی انجام می‌شود؟',
    questionEn: 'What is minimum withdrawal and payout method?',
    answerFa: 'تسویه و برداشت درآمد فقط و فقط به‌صورت تتر (USDT TRC20) به آدرس ولت شما انجام می‌پذیرد. حداقل برداشت ۵۰ دلار تتر بوده و بین ۲ الی ۱۲ ساعت واریز می‌شود.',
    answerEn: 'Streamer earnings are paid out exclusively via Tether USDT (TRC20) to your wallet address. Minimum withdrawal is 50 USDT, processed in 2-12h.',
    popular: true,
    active: true
  },
  {
