...
import { VerifiedBadge } from './ProfilePage';
...
export default function AdminPage({
  ...
  setAdminBroadcastTarget,
  adminSystemFeePercent,
  setAdminSystemFeePercent,
  adminAiModerationEnabled,
  setAdminAiModerationEnabled,
  adminRiskThreshold,
  setAdminRiskThreshold,
  adminSelectedReportForAi,
  setAdminSelectedReportForAi,
  adminAiAnalysisResult,
  setAdminAiAnalysisResult,
  adminIsAnalyzingReport,
  setAdminIsAnalyzingReport,
  adminWhitelistUsers,
  setAdminWhitelistUsers,
  adminNewWhitelistId,
  setAdminNewWhitelistId,
  adminNewWhitelistName,
  setAdminNewWhitelistName,
  adminNewWhitelistRole,
  setAdminNewWhitelistRole,
  adminIsAddWhitelistModalOpen,
  setAdminIsAddWhitelistModalOpen,
  isUserSuperAdmin,
  isUserAuthorizedAdmin,
  currentTelegramId,
  handleRunAiReportAnalysis,
  handleRunAiChatModeration,
  handleRunAiSupportAssistant,
  handleRunAiStreamerVerification,
  handleRunAiReferralAudit,
  ...props
}) {
