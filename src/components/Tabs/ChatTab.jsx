...
export default function ChatTab(props) {
  const {
    ...
    directChatsList, setDirectChatsList,
    chatMessageInput, setChatMessageInput,
    chatSearchFilterTab, setChatSearchFilterTab,
    chatIsPinnedFilter, setChatIsPinnedFilter,
    chatUnreadOnlyFilter, setChatUnreadOnlyFilter,
    chatSelectedMediaFile, setChatSelectedMediaFile,
    chatIsRecordingAudio, setChatIsRecordingAudio,
    chatAudioRecordSeconds, setChatAudioRecordSeconds,
    chatShowEmojiPicker, setChatShowEmojiPicker,
    chatReplyToMessage, setChatReplyToMessage,
    chatSelectedGifts, setChatSelectedGifts,
    chatIsGiftPickerOpen, setChatIsGiftPickerOpen,
    chatGiftsList,
    handleSendDirectChatMessage,
    handleSendGiftInChat,
    handleTogglePinChat,
    handleMuteChat,
    handleDeleteChat,
    showToast, loc, isRtl
